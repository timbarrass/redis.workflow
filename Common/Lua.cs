...
namespace Redis.Workflow.Common
{
    internal static class Lua
    {
        ...
        private static readonly string _cleanupWorkflowScript =
                  "local task = redis.call(\"rpop\", \"workflow-tasks-\"..@workflowId)\r\n"
                + "while task do\r\n"
                ...
                + "task = redis.call(\"rpop\", \"workflow-tasks-\"..@workflowId)\r\n"
                + "end\r\n"
                + "redis.call(\"lrem\", \"workflowComplete\", 1, @workflowId)\r\n"
                + "redis.call(\"lrem\", \"workflowFailed\", 1, @workflowId)\r\n"
                + "redis.call(\"del\", \"workflow-tasks-\"..@workflowId)\r\n"
                + "redis.call(\"del\", \"workflow-remaining-\"..@workflowId)\r\n"
