...
{
    /// <summary>
    /// A simple example task handler. It spins up a thread on the thread pool that does
    /// nothing but state it's doing work, and call the workflow result handler to keep
    /// things ticking over.
    /// </summary>
